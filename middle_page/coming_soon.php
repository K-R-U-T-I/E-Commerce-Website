<body class="fullwidth">
	...
	<!-- Page -->
		...
		<!-- <div class="sidebar-wrapper">
			<div class="sidebar-top"><a href="coming-soon.html#" class="slidepanel-toggle"><i class="icon icon-left-arrow-circular"></i></a></div>
			...
			<div class="sidebar-bot">
				<div class="share-button toTop">
					...
					<ul class="social-list">
						<li><a href="coming-soon.html#" class="icon icon-google google"></a></li>
						<li><a href="coming-soon.html#" class="icon icon-fancy fancy"></a></li>
						<li><a href="coming-soon.html#" class="icon icon-pinterest pinterest"></a></li>
						<li><a href="coming-soon.html#" class="icon icon-twitter-logo twitter"></a></li>
						<li><a href="coming-soon.html#" class="icon icon-facebook-logo facebook"></a></li>
					</ul>
				</div>
			</div>
		</div> -->
	...
	s-2.336,0.471-3.151,1.414C154.728,38.104,154.32,39.407,154.32,41.069z" />
						...
						<div class="wrapper wrapper-form">
							...
							<div class="center-col">
								<a class="icon icon-star-fill bookmark" href="coming-soon.html#"></a>
							</div>
						</div>
					</div>
				</div>
