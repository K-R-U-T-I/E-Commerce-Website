			...
			<main class="page-main">
								...
								<div class="swiper-wrapper">
										...
										<div class="wrapper">
											...
											<div class="caption animate" data-animate="fadeIn">
												...
												<div class="animate" data-animate="fadeIn" data-delay="2000">
													<!-- coolbutton -->
													<a href="index-popup.html#" class="cool-btn" style="-webkit-clip-path: url(#coolButton); clip-path: url(#coolButton);"> <span>MORE</span> </a>
													<svg class="clip-svg">
														<defs>
									...
									<div class="swiper-slide" data-thumb="images/slider/slide-03-thumb.png">
										<div class="wrapper">
											...
											<a href="index-popup.html#" class="text3-6 animate" data-animate="rubberBand" data-delay="2500"> SHOP NOW </a>
										</div>
									</div>
									<div class="swiper-slide" data-thumb="images/slider/slide-04-thumb.png">
										<div class="wrapper">
											...
											<a href="index-popup.html#" class="text4-4 animate" data-animate="bounceInLeft" data-delay="1500">SHOP NOW</a>
										</div>
									</div>
								</div>
								<!-- pagination -->
				...
				<div class="block">
					<div class="container">
						<ul class="filters filters-product style2">
							<li><a href="index-popup.html#" class="filter-label">All<span class="count"></span></a></li>
							<li><a href="index-popup.html#" class="filter-label" data-filter=".category1">New<span class="count"></span></a></li>
							<li><a href="index-popup.html#" class="filter-label" data-filter=".category2">Sale<span class="count"></span></a></li>
						</ul>
										...
										<div class="product-item-info">
											...
											<div class="product-item-photo">
												...
												<div class="product-item-gallery-main">
													<a href="index-popup.html#"><img class="product-image-photo" src="images/products/product-16-c1.jpg" alt=""></a>
												...
												<!-- Product Actions -->
												<a href="index-popup.html#" title="Add to Wishlist" class="wishlist active"> <i class="icon icon-heart"></i><span>Add to Wishlist</span> </a>
												<div class="product-item-actions">
													<div class="share-button toBottom">
														<span class="toggle"></span>
														<ul class="social-list">
															<li>
																<a href="index-popup.html#" class="icon icon-google google"></a>
															</li>
															<li>
																<a href="index-popup.html#" class="icon icon-fancy fancy"></a>
															</li>
															<li>
																<a href="index-popup.html#" class="icon icon-pinterest pinterest"></a>
															</li>
															<li>
																<a href="index-popup.html#" class="icon icon-twitter-logo twitter"></a>
															</li>
															<li>
																<a href="index-popup.html#" class="icon icon-facebook-logo facebook"></a>
															</li>
														</ul>
													</div>
												</div>
											...
											<div class="product-item-details">
												...
												<ul class="color-swatch hidden-xs">
													<li class="active">
														<a data-image="images/products/product-16-c1.jpg" href="index-popup.html#"><img src="images/colorswatch/color-blue.png" alt="Blue"></a>
													</li>
													<li>
														<a data-image="images/products/product-16-c2.jpg" href="index-popup.html#"><img src="images/colorswatch/color-grey.png" alt="Gray"></a>
													</li>
													<li>
														<a data-image="images/products/product-16-c3.jpg" href="index-popup.html#"><img src="images/colorswatch/color-red.png" alt="Red"></a>
													</li>
													<li>
														<a data-image="images/products/product-16-c4.jpg" href="index-popup.html#"><img src="images/colorswatch/color-violet.png" alt="Violet"></a>
													</li>
													<li>
														<a data-image="images/products/product-16-c5.jpg" href="index-popup.html#"><img src="images/colorswatch/color-green.png" alt="Green"></a>
													</li>
												</ul>
									...
									<div class="product-item-inside">
										<div class="product-item-info">
											...
											<div class="product-item-photo">
												...
												<div class="carousel-inside slide" data-ride="carousel">
													<div class="carousel-inner" role="listbox">
														<div class="item active">
															<a href="index-popup.html#"><img class="product-image-photo" src="images/products/product-20.jpg" alt=""></a>
														</div>
														<div class="item">
															<a href="index-popup.html#"><img class="product-image-photo" src="images/products/product-20-1.jpg" alt=""></a>
														</div>
														<div class="item">
															<a href="index-popup.html#"><img class="product-image-photo" src="images/products/product-20-2.jpg" alt=""></a>
														</div>
													</div>
												...
												<!-- /product main photo  -->
												<!-- Product Actions -->
												<a href="index-popup.html#" title="Add to Wishlist" class="no_wishlist"> <i class="icon icon-heart"></i><span>Add to Wishlist</span> </a>
												<div class="product-item-actions">
													<div class="share-button toBottom">
														<span class="toggle"></span>
														<ul class="social-list">
										...
										<div class="product-item-info">
											...
											<div class="product-item-photo">
												...
												<div class="product-item-gallery">
													<!-- product main photo -->
													<div class="product-item-gallery-main">
														<a href="index-popup.html#"><img class="product-image-photo" src="images/products/product-26.jpg" alt=""></a>
														<a href="quick-view.html" title="Quick View" class="quick-view-link quick-view-btn"> <i class="icon icon-eye"></i><span>Quick View</span></a>
													</div>
													<!-- /product main photo  -->
												</div>
												...
												<div class="product-item-gallery-previews-wrapper">
													<div class="product-item-gallery-previews">
														<div class="item">
															<a href="index-popup.html#"><img src="images/products/product-26.jpg" data-image="images/products/product-26.jpg" alt=""></a>
														</div>
														<div class="item">
															<a href="index-popup.html#"><img src="images/products/product-26-1.jpg" data-image="images/products/product-26-1.jpg" alt=""></a>
														</div>
														<div class="item">
															<a href="index-popup.html#"><img src="images/products/product-26-2.jpg" data-image="images/products/product-26-2.jpg" alt=""></a>
														</div>
													</div>
									...
									<div class="product-item-inside">
										<div class="product-item-info">
											...
											<div class="product-item-photo">
												...
												<!-- product main photo -->
												<div class="product-item-gallery-main">
													<a href="index-popup.html#"><img class="product-image-photo" src="images/products/product-25.jpg" alt=""></a>
													<a href="quick-view.html" title="Quick View" class="quick-view-link quick-view-btn"> <i class="icon icon-eye"></i><span>Quick View</span></a>
												</div>
												<!-- /product main photo  -->
												<div class="countdown-box hidden-xs">
												...
												<div class="product-item-gallery-previews-wrapper">
													<div class="product-item-gallery-previews">
														<div class="item">
															<a href="index-popup.html#"><img src="images/products/product-25.jpg" data-image="images/products/product-25.jpg" alt=""></a>
														</div>
														<div class="item">
															<a href="index-popup.html#"><img src="images/products/product-25-1.jpg" data-image="images/products/product-25-1.jpg" alt=""></a>
														</div>
													</div>
													<div class="carousel-arrows"></div>
												</div>
										...
										<div class="product-item-info">
											...
											<div class="product-item-photo">
												<div class="product-item-gallery">
													<!-- product main photo -->
													<div class="product-item-gallery-main">
														<a href="index-popup.html#"><img class="product-image-photo" src="images/products/product-18.jpg" alt=""></a>
														<a href="quick-view.html" title="Quick View" class="quick-view-link quick-view-btn"> <i class="icon icon-eye"></i><span>Quick View</span></a>
													</div>
													<!-- /product main photo  -->
												</div>
												...
												<div class="product-item-gallery-previews-wrapper">
													<div class="product-item-gallery-previews">
														<div class="item">
															<a href="index-popup.html#"><img src="images/products/product-18.jpg" data-image="images/products/product-18.jpg" alt=""></a>
														</div>
														<div class="item">
															<a href="index-popup.html#"><img src="images/products/product-18-1.jpg" data-image="images/products/product-18-1.jpg" alt=""></a>
														</div>
													</div>
													<div class="carousel-arrows"></div>
												</div>
										...
										<div class="product-item-info">
											...
											<div class="product-item-photo">
												...
												<div class="product-item-gallery">
													<!-- product main photo -->
													<div class="product-item-gallery-main">
														<a href="index-popup.html#"><img class="product-image-photo" src="images/products/product-10.jpg" alt=""></a>
														<a href="quick-view.html" title="Quick View" class="quick-view-link quick-view-btn"> <i class="icon icon-eye"></i><span>Quick View</span></a>
													</div>
													<!-- /product main photo  -->
												</div>
									...
									<div class="product-item-inside">
										<div class="product-item-info">
											...
											<div class="product-item-photo">
												...
												<!-- product main photo -->
												<div class="product-item-gallery-main">
													<a href="index-popup.html#"><img class="product-image-photo" src="images/products/product-17.jpg" alt=""></a>
													<a href="quick-view.html" title="Quick View" class="quick-view-link quick-view-btn"> <i class="icon icon-eye"></i><span>Quick View</span></a>
												...
												<div class="product-item-gallery-previews-wrapper">
													<div class="product-item-gallery-previews">
														<div class="item">
															<a href="index-popup.html#"><img src="images/products/product-17.jpg" data-image="images/products/product-17.jpg" alt=""></a>
														</div>
														<div class="item">
															<a href="index-popup.html#"><img src="images/products/product-17-1.jpg" data-image="images/products/product-17-1.jpg" alt=""></a>
														</div>
														<div class="item">
															<a href="index-popup.html#"><img src="images/products/product-17-2.jpg" data-image="images/products/product-17-2.jpg" alt=""></a>
														</div>
													</div>
													<div class="carousel-arrows"></div>
												</div>
										...
										<div class="product-item-info">
											...
											<div class="product-item-photo">
												...
												<div class="product-item-gallery">
													<!-- product main photo -->
													<div class="product-item-gallery-main">
														<a href="index-popup.html#"><img class="product-image-photo" src="images/products/product-27.jpg" alt=""></a>
														<a href="quick-view.html" title="Quick View" class="quick-view-link quick-view-btn"> <i class="icon icon-eye"></i><span>Quick View</span></a>
													</div>
													<!-- /product main photo  -->
												</div>
				...
				<div class="block banners-with-pad">
					<div class="container">
						<div class="row">
							<div class="col-md-7">
								<a href="index-popup.html#" class="banner-wrap">
								...
								<a href="index-popup.html#bannerLink" class="banner-wrap">
								...
								<div class="blog-carousel">
									<div class="blog-item">
										...
										<div class="blog-item-info">
											...
											<div class="blog-item-links"> <span class="pull-left"> <span><a href="index-popup.html#" class="readmore">Read more</a></span> </span> <span class="pull-right"> <span>Post by <a href="index-popup.html#">Admin</a></span> </span>
											</div>
										</div>
									</div>
									<!-- /Blog Carousel Item -->
											...
											<div class="product-item-inside">
												<div class="product-item-info">
													...
													<div class="product-item-photo">
														<!-- product main photo -->
														<div class="product-item-gallery-main">
															<a href="index-popup.html#"><img class="product-image-photo" src="images/products/product-19.jpg" alt=""></a>
															<a href="quick-view.html" title="Quick View" class="quick-view-link quick-view-btn"> <i class="icon icon-eye"></i><span>Quick View</span></a>
														</div>
														<!-- /product main photo  -->
														<!-- Product Label -->
														...
														<div class="product-item-gallery-previews-wrapper">
															<div class="product-item-gallery-previews">
																<div class="item">
																	<a href="index-popup.html#"><img src="images/products/product-19.jpg" data-image="images/products/product-19.jpg" alt=""></a>
																</div>
																<div class="item">
																	<a href="index-popup.html#"><img src="images/products/product-19-1.jpg" data-image="images/products/product-19-1.jpg" alt=""></a>
																</div>
																<div class="item">
																	<a href="index-popup.html#"><img src="images/products/product-19-2.jpg" data-image="images/products/product-19-2.jpg" alt=""></a>
																</div>
																<div class="item">
																	<a href="index-popup.html#"><img src="images/products/product-19-3.jpg" data-image="images/products/product-19-3.jpg" alt=""></a>
																</div>
															</div>
															<div class="carousel-arrows"></div>
														</div>
													...
													<div class="product-item-details">
														...
														<ul class="color-swatch hidden-xs">
															<li class="active">
																<a data-image="images/products/product-19.jpg" href="index-popup.html#"><img src="images/colorswatch/color-yellow.png" alt="Yellow"></a>
															</li>
															<li>
																<a data-image="images/products/product-19-c1.jpg" href="index-popup.html#"><img src="images/colorswatch/color-blue.png" alt="Blue"></a>
															</li>
															<li>
																<a data-image="images/products/product-19-c2.jpg" href="index-popup.html#"><img src="images/colorswatch/color-red.png" alt="Red"></a>
															</li>
															<li>
																<a data-image="images/products/product-19-c3.jpg" href="index-popup.html#"><img src="images/colorswatch/color-grey.png" alt="Grey"></a>
															</li>
															<li>
																<a data-image="images/products/product-19-c4.jpg" href="index-popup.html#"><img src="images/colorswatch/color-green.png" alt="Green"></a>
															</li>
															<li>
																<a data-image="images/products/product-19-c5.jpg" href="index-popup.html#"><img src="images/colorswatch/color-violet.png" alt="Violet"></a>
															</li>
														</ul>
														<div class="product-item-rating"> <i class="icon icon-star-fill"></i><i class="icon icon-star-fill"></i><i class="icon icon-star-fill"></i><i class="icon icon-star-fill"></i><i class="icon icon-star-fill"></i></div>
														<button class="btn add-to-cart" data-product="789123"> <i class="icon icon-cart"></i><span>Add to Cart</span> </button>
												...
												<div class="product-item-info">
													...
													<div class="product-item-photo">
														...
														<div class="product-item-gallery">
															<!-- product main photo -->
															<div class="product-item-gallery-main">
																<a href="index-popup.html#"><img class="product-image-photo" src="images/products/product-13.jpg" alt=""></a>
																<a href="quick-view.html" title="Quick View" class="quick-view-link quick-view-btn"> <i class="icon icon-eye"></i><span>Quick View</span></a>
															</div>
															<!-- /product main photo  -->
														</div>
											...
											<div class="product-item-inside">
												<div class="product-item-info">
													...
													<div class="product-item-photo">
														...
														<!-- product main photo -->
														<div class="product-item-gallery-main">
															<a href="index-popup.html#"><img class="product-image-photo" src="images/products/product-11-1.jpg" alt=""></a>
															<a href="quick-view.html" title="Quick View" class="quick-view-link quick-view-btn"> <i class="icon icon-eye"></i><span>Quick View</span></a>
														</div>
														<!-- /product main photo  -->
														<!-- Product Actions -->
														...
														<div class="product-item-gallery-previews-wrapper">
															<div class="product-item-gallery-previews">
																<div class="item">
																	<a href="index-popup.html#"><img src="images/products/product-11.jpg" data-image="images/products/product-11.jpg" alt=""></a>
																</div>
																<div class="item">
																	<a href="index-popup.html#"><img src="images/products/product-11-1.jpg" data-image="images/products/product-11-1.jpg" alt=""></a>
																</div>
																<div class="item">
																	<a href="index-popup.html#"><img src="images/products/product-11-2.jpg" data-image="images/products/product-11-2.jpg" alt=""></a>
																</div>
															</div>
															<div class="carousel-arrows"></div>
														</div>
