					...
					<div class="container">
						<div class="cart-table wishlist">
							...
							<div class="table-row">
								...
								<div class="remove">
									<a href="wishlist.html#"><span>Remove</span><i class="fa fa-close-2"></i></a>
								</div>
								<div class="continue">
									<a href="wishlist.html#"><span>Continue</span><i class="fa fa-check"></i></a>
								</div>
							</div>
							<div class="table-row">
								<div class="photo">
						...
						<div class="row">
							<div class="col-md-3 total-wrapper">
								...
								<div class="cart-action">
									...
									<a href="wishlist.html#">Checkout with Multiple Addresses</a>
								</div>
							</div>
							<div class="col-sm-6 col-md-5">
								<h2>Estimate Shipping and Tax</h2>
								<form class="white" action="wishlist.html#">
