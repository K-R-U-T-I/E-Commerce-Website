...
<!-- Footer -->
	<footer class="page-footer variant4 fullboxed">
		<div class="footer-top bg" data-bg="images/block-bg-5.jpg">
			<div class="container">
				<div class="row">
					<div class="col-md-6">
						<!-- newsletter -->
						<div class="newsletter variant3">
							<div class="footer-logo">
								<a href="#">
									...
									<img src="images/kt_logo3.jpg" height="70" width="120">
								</a>
							</div>
							<div>
								<!-- input-group -->
								<form action="footer-variant-4.html#">
					...
					<div class="col-md-3">
						...
						<div class="news-item">
							...
							<div class="news-text">
								...
								<p><a href="footer-variant-4.html#" class="readmore">Read more
					...
					<div class="col-md-3">
						<h3>Twitter</h3>
						<a class="twitter-timeline" href="https://twitter.com" data-chrome="transparent nofooter noborders noheader noscrollbar" data-tweet-limit="1" data-widget-id="677235277925113856">Tweets by @KTcoMpaNY</a>
						<script>
							! function (d, s, id) {
				...
				<div class="row">
						...
						<div class="footer-block collapsed-mobile">
							...
							<div class="collapsed-content">
								<ul class="marker-list">
									...
									<li><a href="index.php?page=faq">Customer Service</a></li>
									<!-- <li><a href="index.php?page=about_us">Privacy Policy</a></li> -->
									<li><a href="index.php?page=blog">Our Blog</a></li>
									<li><a href="index.php?page=search">Search Terms</a></li>
								</ul>
							</div>
						</div>
					</div>
					<div class="col-md-3 col-lg-3">
						<div class="footer-block collapsed-mobile">
							...
							<div class="collapsed-content">
								<ul class="marker-list">
									<li><a href="index.php?page=sign_up">My account</a></li>
									<li><a href="index.php?page=login">Logination</a></li>
									<li><a href="index.php?page=cart">My cart</a></li>
									<li><a href="index.php?page=wishlist">My wishlist</a></li>
									<li><a href="index.php?page=search">Search Terms</a></li>
								</ul>
							</div>
						</div>
							...
							<div class="collapsed-content">
								<ul class="simple-list">
									...
									<li><i class="fa fa-envelope"></i>
										<a href="mailto:support@seiko.com">support@seiko.com</a></li>
									<li><i class="fa fa-clock-o"></i>
									8:00 - 19:00, Monday - Saturday</li>
								</ul>
								<div class="footer-social">
									<a href="#"><i class="fa fa-facebook" style="font-size: 40px;"></i>
									<a href="#"><i class="fa fa-twitter" style="font-size: 40px;"></i></a> 
									<a href="#"><i class="fa fa-skype" style="font-size: 40px;"></i></a> 
									<a href="#"><i class="fa fa-vimeo-square" style="font-size: 40px;"></i></a>
								</div>
							</div>
						</div>
					</div>
