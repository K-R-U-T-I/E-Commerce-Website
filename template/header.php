<body class="fullwidth">
	...
	<header class="page-header variant-1 fullboxed sticky smart">
		<div class="navbar">
			<div class="container">
				<!-- Menu Toggle -->
				<div class="menu-toggle"><a href="header-variant-1.html#" class="mobilemenu-toggle"><i class="fa fa-menu"></i></a></div>
				<!-- /Menu Toggle -->
				<!-- Header Cart -->
				...
				<div class="header-links">
					...
					<div class="header-link header-select dropdown-link header-language">
						...
						<a href="#"><img src="images/flags/eng.png" alt />
					...
					<div class="header-link header-select dropdown-link header-currency">
						...
						<ul class="dropdown-container">
							<li><a href="header-variant-1.html#"><span class="symbol">€</span>EUR</a></li>
							<li class="active"><a href="header-variant-1.html#"><span class="symbol">$</span>USD</a></li>
							<li><a href="header-variant-1.html#"><span class="symbol">£</span>GBP</a></li>
						</ul>
					</div>
					<!-- /Header Currency -->
					<!-- Header Account -->
...
error_reporting(0);
	//if(isset($_POST['register'])){	
		    ...
		    $ur_id=$_SESSION['user_id'];
			    ...
			    $select = "SELECT * FROM user WHERE user_id='$ur_id'";
...
?>
	...
	<?php 			if($ur_id!=''){	
						...
						?><h4>Welcome,<?php echo @$row['fname']; ?>.</h4>
				
						<a href="#">
							<img src="images/UPLOADS/user_profile/<?php echo @$row['profile_pic']; 
							?>" height="50" width="50" >
							<i class="fa fa-user" style="font-size: 25px;"></i></a>
						<?php }else{ ?>
							<i class="fa fa-user" style="font-size: 25px;"></i></a>
						<?php }
	...
	?>							
						<div class="dropdown-container right">
							...
							<!-- form -->
							<form action="index.php?page=login_action" method="post" enctype="formdata/multi-part">
							...
							<div class="bottom-text">Create a 
								<a href="index.php?page=sign_up">New Account</a> ||
				...
				<div class="header-link header-search header-search">
					<div class="exp-search">
						<form>
							...
							<span class="exp-icon-search"><i class="fa fa-search"></i>
							</span> 
							<span class="exp-search-close"><i class="fa fa-close"></i></span>
						</form>
					</div>
				</div>
				<!-- /Header Search -->
				...
				<!-- <div class="mobilemenu dblclick">
					<div class="mobilemenu-header">
						...
						<a href="header-variant-1.html#" class="mobilemenu-toggle"></a>
					</div>
					<div class="mobilemenu-content">
						<ul class="nav">
							...
							<li>
								<a href="header-variant-1.html#" title="">Pages</a><span class="arrow"></span>
								<ul>												<li>
										...
										<ul>
											...
											<li><a href="category-empty.html" title="">Empty Category</a></li>         <li><a href="category.html" title="">Products per row</a><span class="arrow"></span>
                                                <ul>
									...
									<li>
										<a href="index.html" title="">Headers</a><span class="arrow"></span>													<ul>
                                            ...
                                            <li> <a href="header-variant-8.html" title="">Header 8 (department)</a> </li>                                                        <li> <a href="header-variant-9.html" title="">Header 9 (creative)</a> </li>
										</ul>
									</li>
									<li>
										<a href="index.html" title="">Footers</a><span class="arrow"></span>
										<ul>														<li> <a href="footer-variant-1.html" title="">Footer 1 (simple)</a> </li>
									...
									<li> <a href="../../banners-grid-online-editor/banners-grid-online-editor.html" title="">Banners / Grid Editor<span class="menu-label-alt">EXCLUSIVE</span></a> </li>
								</ul>
							</li>
                	...
                	<li class="simple-dropdown">
						...
						<div class="sub-menu">
								<!-- <li>
									<a href="#" title="">Pages</a> -->
									<ul>
										<li> <a href="index.php?page=invoice_bill" title="">Invoice Bill</a></li>
										<li> <a href="index.php?page=paypal" title="">Paypal</a></li>

										<li> <a href="index.php?page=category" title="">Category</a> 
										</li>
										<li> <a href="index.php?page=product" title="">Product</a> 
										</li>
										<li> <a href="index.php?page=cart" title="">Cart</a></li>
										<li> <a href="index.php?page=check_out" title="">Check Out</a></li>
										<li> <a href="index.php?page=blog" title="">Blog</a> </li>
										<li> <a href="index.php?page=faq" title="">FAQ</a> </li>
										<li> <a href="index.php?page=search" title="">Search</a> </li>
										<li> <a href="index.php?page=about_us" title="">About Us</a> </li>
										<li> <a href="index.php?page=contact_us" title="">Contact Us
										</a> </li>
										<li> <a href="index.php?page=404" title="">404</a> </li>
										<li> <a href="index.php?page=coming_soon" title="">Coming soon</a> </li>
										<li> <a href="index.php?page=login" title="LogIn">Log In</a> </li>
										<li> <a href="index.php?page=sign_up" title="">Sign Up</a> </li>
										<li> <a href="index.php?page=logout" title="">Log Out</a> </li>
									</ul>
								</div>
							</li>
...
?>
					...
					<a href="index.php?page=sub_category&cat_id=<?php echo $row['cat_id']; ?>">
...
<?php
		$select = "SELECT * FROM sub_category WHERE status='active' AND cat_id='".$row['cat_id']."'";
		$query = mysqli_query($conn, $select);
		while($result = mysqli_fetch_assoc($query)){
?>
								<!-- megamenu column -->
								<div class="col">
									<a class="category-image" href="index.php?page=prod&sub_id=<?php echo $result['sub_cat_id'];?>">
										<img src="admin_theme/Uploads/sub-category_img/<?php echo $result['profile']; ?>" heigth="300" width="250" alt />
									</a>
									<div class="category-title">
										<a href="index.php?page=prod&sub_id=<?php echo $result['sub_cat_id'];?>"><?php echo $result['sub_cat_name']; ?>
										<!-- <a href="#">Only New -->
